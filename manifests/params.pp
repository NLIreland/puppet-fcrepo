...
class fcrepo::params {
    ...
    $fcrepo_repository_json = 'https://raw.githubusercontent.com/fcrepo4/fcrepo4/fcrepo-4.6.1/fcrepo-configs/src/main/resources/config/jdbc-mysql/repository.json'
    ...
    $fcrepo_warsource    = 'https://github.com/fcrepo4/fcrepo4/releases/download/fcrepo-4.6.1/fcrepo-webapp-4.6.1.war'
