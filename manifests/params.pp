...
class fcrepo::params {
    ...
    $fcrepo_infinispan_xml = 'https://raw.githubusercontent.com/fcrepo4/fcrepo4/fcrepo-4.7.4/fcrepo-configs/src/main/resources/config/jdbc-mysql/repository.json'
