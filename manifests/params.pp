...
class fcrepo::params {
    ...
    $fcrepo_repository_json = 'https://raw.githubusercontent.com/fcrepo4/fcrepo4/fcrepo-4.7.4/fcrepo-configs/src/main/resources/config/jdbc-mysql/repository.json'
    $fcrepo_jgroups_fcrepo_tcp_xml = 'https://raw.githubusercontent.com/fcrepo4/fcrepo4/fcrepo-4.7.4/fcrepo-configs/src/main/resources/config/jgroups-fcrepo-tcp.xml'
    $fcrepo_warsource    = 'https://github.com/fcrepo4/fcrepo4/releases/download/fcrepo-4.7.4/fcrepo-webapp-4.7.4.war'
    $fcrepo_db_host      = 'localhost'
    $fcrepo_db_port      = '3306'
    $fcrepo_db_username  = 'fcrepouser'
    $fcrepo_db_password  = 'changeme'
    $fcrepo_cycle_server_required = false
    $fcrepo_cycle_server = '/usr/bin/cycle_fedora.sh'
